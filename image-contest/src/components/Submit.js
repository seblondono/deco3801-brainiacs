...
// Submit component. To be rendered at the about/submit and participate page
class UploadImage extends Component {

	// Manage routing to voting home page
	goToContest(e) {
		e.preventDefault();
				...
				<div className="rn_Padding" id="yui_3_17_2_3_1505105476525_15">
					...
					<form id="rn_QuestionSubmit" method="#" onSubmit={(e)=> this.goToContest(e)}>
						...
						<div id="rn_TextInput_10" className="rn_TextInput rn_Input">
							...
							<div id="rn_TextInput_10_LabelContainer">
								<label htmlFor="rn_TextInput_10_Incident.Subject" id="rn_TextInput_10_Label" className="rn_Label">
									Image Title:<span className="rn_Required" aria-label="Required"></span></label>
							</div>
							<input type="text" id="rn_TextInput_10_Incident.Subject" name="Incident.Subject" className="rn_Text" maxLength="240" required="" placeholder='The title of your image'/>
							<div id="rn_TextInput_10_LabelContainer">
								<label htmlFor="rn_TextInput_10_Incident.Subject" id="rn_TextInput_10_Label" className="rn_Label">
